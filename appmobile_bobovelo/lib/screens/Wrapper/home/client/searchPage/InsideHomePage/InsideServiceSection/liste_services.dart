...
class ServicesList extends StatefulWidget {
  String repairville = '';
  ServicesList({Key? key, required this.repairville}) : super(key: key);
          ...
          return Column(
              children: snapshot.data!.docs
                  .where((DocumentSnapshot<Object?> element) =>
                      element['ville'] == widget.repairville ||
                      element['categorie'] == widget.repairville)
                  .map((DocumentSnapshot document) {
            Map<String, dynamic> service =
                document.data()! as Map<String, dynamic>;

            String idService = document.id;
            print('inside liste des service');
            print(widget.repairville);
                    ...
                    ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => DemandeService(
                                      currentIdService: idService)));
                        },
