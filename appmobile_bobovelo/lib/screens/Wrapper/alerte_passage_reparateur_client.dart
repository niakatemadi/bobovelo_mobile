...
class PassageClientReparateur extends StatefulWidget {
  ...
  final client;
  const PassageClientReparateur(
      {Key? key, required this.repairorclient, required this.client})
      : super(key: key);

  @override
  State<PassageClientReparateur> createState() =>
      _PassageClientReparateurState();
}
